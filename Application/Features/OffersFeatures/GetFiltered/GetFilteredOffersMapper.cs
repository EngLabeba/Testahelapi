...
public sealed class GetFilteredOffersMapper : Profile
{
    public GetFilteredOffersMapper()
    {
        CreateMap<GetFilteredOffersRequest, Offer>();
        CreateMap<Offer, GetFilteredOffersResponse>()
        ...
        CreateMap<PaginatedList<Offer>, PaginatedList<GetFilteredOffersResponse>>();
    }
}
